...
\restrict eoap642Q02cA9kStP1Wrz35uDPIdDcIN9gnLf5PzYwDLXmaazehkDadjr9QLsD0
...
CREATE TABLE "public"."task" (
    ...
    "comments" "text",
    "timeframe_start" timestamp without time zone NOT NULL,
    "timeframe_end" timestamp without time zone NOT NULL,
...
--
-- Name: task task_assigned_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."task"
    ADD CONSTRAINT "task_assigned_user_fkey" FOREIGN KEY ("assigned_user") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: task task_blocked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."task"
    ADD CONSTRAINT "task_blocked_by_fkey" FOREIGN KEY ("blocked_by") REFERENCES "public"."task"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."task"
    ADD CONSTRAINT "task_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."task"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict eoap642Q02cA9kStP1Wrz35uDPIdDcIN9gnLf5PzYwDLXmaazehkDadjr9QLsD0
